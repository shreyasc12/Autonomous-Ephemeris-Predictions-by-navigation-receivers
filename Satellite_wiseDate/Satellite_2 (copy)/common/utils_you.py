...
def create_evaluation_df(predictions, test_inputs, H, scaler):
	...
	for i in list_names:
		...
		final_names.append(i + '_OMEGA')
		final_names.append(i + '_SV_Clock_Bias')
		final_names.append(i + '_SV_Clock_Drift')
		final_names.append(i + '_SV_Clock_Drift_Rate')
		final_names.append(i + '_IODE')
		final_names.append(i + '_Crs')
		final_names.append(i + '_Del_n')
		final_names.append(i + '_Cuc')
		final_names.append(i + '_Cus')
		final_names.append(i + '_Toe')
		final_names.append(i + '_Cic')
		final_names.append(i + '_Cis')	
		final_names.append(i + '_Crc')
		final_names.append(i + '_OMEGA_DOT')
		final_names.append(i + '_I_dot')
		final_names.append(i + '_Codes')
		final_names.append(i + '_GPS_week')
		final_names.append(i + '_L2_P_Data_flag')
		final_names.append(i + '_SV_accuracy')
		final_names.append(i + '_SV_health')
		final_names.append(i + '_Tgd')
		final_names.append(i + '_IODC')
		final_names.append(i + '_T_Tx')	
		final_names.append(i + '_Fit_Interval')
	...
	"""
	list_me = ['sqrt_A' , 'e' , 'M0' , 'i0' , 'omega' , 'OMEGA' , 'SV_Clock_Bias' , 'SV_Clock_Drift' , 'SV_Clock_Drift_Rate' , 'IODE' ,'Crs','Del_n','Cuc','Cus','Toe','Cic','Cis','Crc','OMEGA_dot','I_dot','Codes','GPS_week','L2_P_Data_flag',
